 ...
 */
export interface BTListResponseBTRevisionInfo {
    /**
     * URI for current page of resources.
     * @type {string}
     * @memberof BTListResponseBTRevisionInfo
     */
    href?: string;
    /**
...
/**
 * Check if a given object implements the BTListResponseBTRevisionInfo interface.
 */
export function instanceOfBTListResponseBTRevisionInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTListResponseBTRevisionInfoFromJSON(json: any): BTListResponseBTRevisionInfo {
    return BTListResponseBTRevisionInfoFromJSONTyped(json, false);
}

export function BTListResponseBTRevisionInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTListResponseBTRevisionInfo {
...
export function BTListResponseBTRevisionInfoToJSON(value?: BTListResponseBTRevisionInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
