 ...
 */
export interface BTAppElementBasicInfo {
    /**
     * 
     * @type {string}
     * @memberof BTAppElementBasicInfo
     */
    changeId?: string;
    /**
...
/**
 * Check if a given object implements the BTAppElementBasicInfo interface.
 */
export function instanceOfBTAppElementBasicInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTAppElementBasicInfoFromJSON(json: any): BTAppElementBasicInfo {
    return BTAppElementBasicInfoFromJSONTyped(json, false);
}

export function BTAppElementBasicInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTAppElementBasicInfo {
...
export function BTAppElementBasicInfoToJSON(value?: BTAppElementBasicInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
