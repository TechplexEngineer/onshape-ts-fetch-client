 ...
 */
export interface BTViewDataInfo {
    /**
     * 
     * @type {number}
     * @memberof BTViewDataInfo
     */
    angle?: number;
    /**
     * 
...
/**
 * Check if a given object implements the BTViewDataInfo interface.
 */
export function instanceOfBTViewDataInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTViewDataInfoFromJSON(json: any): BTViewDataInfo {
    return BTViewDataInfoFromJSONTyped(json, false);
}

export function BTViewDataInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTViewDataInfo {
...
export function BTViewDataInfoToJSON(value?: BTViewDataInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
