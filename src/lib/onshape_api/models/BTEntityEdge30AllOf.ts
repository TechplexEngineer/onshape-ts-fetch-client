 ...
 */
export interface BTEntityEdge30AllOf {
    /**
     * 
     * @type {string}
     * @memberof BTEntityEdge30AllOf
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTEntityEdge30AllOf interface.
 */
export function instanceOfBTEntityEdge30AllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTEntityEdge30AllOfFromJSON(json: any): BTEntityEdge30AllOf {
    return BTEntityEdge30AllOfFromJSONTyped(json, false);
}

export function BTEntityEdge30AllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTEntityEdge30AllOf {
...
export function BTEntityEdge30AllOfToJSON(value?: BTEntityEdge30AllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
