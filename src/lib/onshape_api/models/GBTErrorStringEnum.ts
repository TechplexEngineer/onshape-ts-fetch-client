...
export const GBTErrorStringEnum = {
    ...
    MoveCurveBoundaryNoSketchEntities: 'MOVE_CURVE_BOUNDARY_NO_SKETCH_ENTITIES',
    MoveCurveBoundaryOnlyWires: 'MOVE_CURVE_BOUNDARY_ONLY_WIRES',
    MoveCurveBoundarySelectHelpPoint: 'MOVE_CURVE_BOUNDARY_SELECT_HELP_POINT',
    MoveCurveBoundaryExtendRequiresOpenCurve: 'MOVE_CURVE_BOUNDARY_EXTEND_REQUIRES_OPEN_CURVE',
    MoveCurveBoundarySplitClosedAtTwoPoints: 'MOVE_CURVE_BOUNDARY_SPLIT_CLOSED_AT_TWO_POINTS',
    HoleNoEndBounds: 'HOLE_NO_END_BOUNDS',
    HoleTapTooDeep: 'HOLE_TAP_TOO_DEEP',
    MoveCurveBoundaryToolIsTarget: 'MOVE_CURVE_BOUNDARY_TOOL_IS_TARGET',
    DrawingIgnoreFaultyParts: 'DRAWING_IGNORE_FAULTY_PARTS',
    IsoclineNoResult: 'ISOCLINE_NO_RESULT',
    IsoclineSelectFaces: 'ISOCLINE_SELECT_FACES',
    IsoclineSelectDirection: 'ISOCLINE_SELECT_DIRECTION',
    IsoclineFailed: 'ISOCLINE_FAILED',
    FgsGenerativeOptMaxIterations: 'FGS_GENERATIVE_OPT_MAX_ITERATIONS',
    FgsGenerativeTargetVolumeLow: 'FGS_GENERATIVE_TARGET_VOLUME_LOW',
    FgsGenerativeTargetVolumeLarge: 'FGS_GENERATIVE_TARGET_VOLUME_LARGE',
    FgsGenerativeThinGeneric: 'FGS_GENERATIVE_THIN_GENERIC',
    FgsGenerativeSymmetryDefProblem: 'FGS_GENERATIVE_SYMMETRY_DEF_PROBLEM',
    FgsGenerativeMinradiusSmall: 'FGS_GENERATIVE_MINRADIUS_SMALL',
    FgsGenerativeMinradiusLarge: 'FGS_GENERATIVE_MINRADIUS_LARGE',
    FgsGenerativeOptInvalidSetup: 'FGS_GENERATIVE_OPT_INVALID_SETUP',
    CurvePatternDistanceTooLarge: 'CURVE_PATTERN_DISTANCE_TOO_LARGE',
    BendReplacementHealFailed: 'BEND_REPLACEMENT_HEAL_FAILED',
    CannotCopyConstraints: 'CANNOT_COPY_CONSTRAINTS',
    Unknown: 'UNKNOWN'
} as const;
