 ...
 */
export interface BTMetadataElementInfoAllOf {
    /**
     * 
     * @type {string}
     * @memberof BTMetadataElementInfoAllOf
     */
    elementId?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTMetadataElementInfoAllOf interface.
 */
export function instanceOfBTMetadataElementInfoAllOf(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMetadataElementInfoAllOfFromJSON(json: any): BTMetadataElementInfoAllOf {
    return BTMetadataElementInfoAllOfFromJSONTyped(json, false);
}

export function BTMetadataElementInfoAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMetadataElementInfoAllOf {
...
export function BTMetadataElementInfoAllOfToJSON(value?: BTMetadataElementInfoAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
