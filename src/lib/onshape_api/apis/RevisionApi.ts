...
export class RevisionApi extends runtime.BaseAPI {
    ...
    /**
     * Erase all revisions of a given partnumber. Only company admins can delete all revisions in a company. All documents that contain the partnumber or use it must be deleted first. This operation is not undoable.
     */
